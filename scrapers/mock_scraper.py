...
FOOD_ITEMS = [
 # --- GRUPO 1: ARROZ Y GRANOS ---
    ...
    {"name": "Leche en Polvo La Vaquita Entera Nutrimás 190g", "price": 3.80, "unit": "g", "quantity": 380, "source": "Supermaxi", "image_url": "https://supermaxi-225de.kxcdn.com/wp-content/uploads/2024/08/7861001248098-1-6.jpg", "features": ["Instantánea", "Semidescremada", "Con vitaminas"]},
    {"name": "Leche en Polvo La Vaquita Entera Nutrimás 190g", "price": 3.65, "unit": "g", "quantity": 380, "source": "Aki", "image_url": "https://supermaxi-225de.kxcdn.com/wp-content/uploads/2024/08/7861001248098-1-6.jpg", "features": ["Instantánea", "Semidescremada", "Con vitaminas"]},
    {"name": "Leche en Polvo La Vaquita Entera Nutrimás 190g", "price": 3.75, "unit": "g", "quantity": 380, "source": "Coral", "image_url": "https://supermaxi-225de.kxcdn.com/wp-content/uploads/2024/08/7861001248098-1-6.jpg", "features": ["Instantánea", "Semidescremada", "Con vitaminas"]},
...
class MockScraper(BaseScraper):
    ...
    def run_scraper_once(self):
        """Lógica para enviar los productos del mock al backend."""
        logging.info(f"🧪 [MOCK] Inyectando {len(FOOD_ITEMS)} productos...")
        for item in FOOD_ITEMS:
            try:
                # Generar ID único
                unique_str = f"{item['name']}-{item['source']}"
                ext_id = f"mock-{hashlib.md5(unique_str.encode()).hexdigest()[:10]}"
                
                # Categoría básica
                category = "General"
                if "Arroz" in item['name']: category = "Arroz"
                elif "Leche" in item['name']: category = "Leche"
                elif "Aceite" in item['name']: category = "Aceite"
                elif "Azúcar" in item['name']: category = "Azúcar"

                producto = {
                    "supermarket": item["source"],
                    "external_id": ext_id,
                    "name": item["name"],
                    "price": item["price"],
                ...
                logging.error(f"Error en item mock: {e}")
